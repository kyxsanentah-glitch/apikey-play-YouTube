const API_KEY = 'b61f53b81836bf0d0c6625e390f6005b'; // Pake Key yang sama
        ...
        function closeDisclaimer() {
            const modal = document.getElementById('disclaimer-modal');
            modal.style.opacity = '0'; // Animasi fade out
            localStorage.setItem('seenDracinDisclaimer', 'true');
            setTimeout(() => modal.classList.add('hidden'), 500); // Tunggu animasi selesai baru hide
        }
            ...
            try {
                ...
                data.results.forEach(movie => {
                    if(movie.poster_path) {
                        ...
                        // Note: TV Series use 'name' instead of 'title' in TMDB
        ...
        function playHero() {
            ...
            // TV Series Embed: Default to Season 1 Episode 1
            frame.src = `https://vidsrc.me/embed/tv/${currentMovieId}/1/1`;
